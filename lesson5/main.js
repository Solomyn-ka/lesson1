...
// let books = [
//     {title : 'tall',pages:12,genre:'drama',authors:['hf','hfj','jkgk']},
//     {title : 'line',pages:14,genre:'fantasy',authors:['hf','hfj','jkgk']},
//     {title : 'fat',pages:105,genre:'drama',authors:['hf','hfj','jkgk']},
//     {title : 'thin',pages:107,genre:'fantasy',authors:['hf','hfj','jkgk']}
// ];
// console.log(books[0])
// console.log(books[1])
// console.log(books[2])
